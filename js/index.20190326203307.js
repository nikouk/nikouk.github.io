...
var a='data-src'; if($('.js-7 .slide4').hasAttr('src')) { a='src'; } $('.js-7 .slide4').attr(a, (dpi>1) ? ((dpi>2) ? 'images/9-03-19-2-1113.jpg' : 'images/9-03-19-2-742.jpg') : 'images/9-03-19-2-371.jpg');}else if($(window).width()>=768){$('.js').attr('src', (dpi>1) ? ((dpi>2) ? 'images/pasted-image-138.png' : 'images/pasted-image-92.png') : 'images/pasted-image-46-1.png');
